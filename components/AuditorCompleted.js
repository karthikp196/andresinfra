...
class AuditorCompleted extends Component {
         ...
         <ScrollView>
            ...
            <View style={tw`bg-white shadow-lg m-3 p-1 rounded-md`}>
                <View  style={tw`flex flex-row`}>
                    ...
                    <View style={tw`flex`}>
                        ...
                        <Text style={tw`text-sm bg-green-500 text-white  rounded-sm font-semibold text-center p-1`}> <Icon  name="sticker-check" size={12}  /> Approved</Text>
                    </View>
                </View>
            ...
            <View style={tw`bg-white shadow-lg m-3 p-1 rounded-md`}>
                <View  style={tw`flex flex-row`}>
                    ...
                    <View style={tw`flex `}>
                    <Text style={tw`text-base m-1 rounded-sm font-semibold text-center`}>  <Icon  name="calendar-today" size={18}  /> 05-09-2021</Text>
                        <Text style={tw`text-sm bg-red-500 text-white  rounded-sm font-semibold text-center p-1`}> <Icon  name="close" size={12}  /> Rejected</Text>
                    </View>
                </View>
...
export default AuditorCompleted;