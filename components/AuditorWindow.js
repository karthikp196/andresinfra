...
class AuditorWindow extends Component {
                ...
                <View style={tw`p-4 m-4 bg-white shadow-md`}>
                     ...
                     <View style={tw` flex flex-row`}>  
                            <View style={tw`m-2 flex flex-row`}>
                                <Button color="#D83939" mode="contained" onPress={navigatehome}>Cancel</Button>
                            </View>

                            <View style={tw`m-2 flex flex-row`}>
                                <Button color="#2f5597" mode="contained" onPress={navigatehome}>Approve</Button>
                            </View>

                            <View style={tw` m-2 flex flex-row`}>
                                <Button color="#D83939" mode="contained" onPress={navigatehome}>Reject</Button>
                            </View>
                    </View>
